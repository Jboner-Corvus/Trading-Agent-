...
│     → Claude + DeepSeek • Contrôle risque en temps réel  │
└─────────────────────────────────────────────────────────┘

┌─────────────────────────────────────────────────────────┐
│                   📊 STRATEGY AGENT                      │
│     "J'ai trouvé 3 opportunités BUY rentables !"         │
│     → Claude • Signaux techniques sur 19 tokens         │
└─────────────────────────────────────────────────────────┘

┌─────────────────────────────────────────────────────────┐
│                   💰 FUNDING AGENT                       │
│     "Arbitrage détecté : +0.23% profit potentiel"       │
│     → Claude + DeepSeek • HyperLiquid ↔ Binance         │
└─────────────────────────────────────────────────────────┘

┌─────────────────────────────────────────────────────────┐
│                  🎭 SENTIMENT AGENT                      │
│     "Twitter bullish : 65% optimisme détecté"           │
│     → OpenAI TTS • Analyse sentiment réseau social      │
└─────────────────────────────────────────────────────────┘
```
...
**NOVAQUOTE est open source !** Tout le monde peut contribuer.
...
- 🌐 **Plus d'exchanges** (KuCoin, Coinbase, Kraken...)
- 📊 **Indicateurs techniques** supplémentaires
- 🧪 **Backtests avancés**
- 🌍 **Internationalisation** (FR, ES, DE...)

**Tous les contributeurs sont listés dans le projet !** 🏆

---

## 📄 Licence

Distribué sous la **MIT License** - voir le fichier [LICENSE](LICENSE) pour plus de détails.
...
- 💸 Tu peux perdre tout ton capital
- 📊 Les performances passées ne garantissent pas les résultats futurs
- 🔍 Teste toujours en petit d'abord

**NOVAQUOTE est un outil d'aide à la décision. Utilise-le à tes propres risques.**
...
- 🐛 **[Issues GitHub](https://github.com/Jboner-Corvus/Trading-Agent-/issues)** - Rapporter un bug
- 💬 **[Discussions GitHub](https://github.com/Jboner-Corvus/Trading-Agent-/discussions)** - Questions & idées
- 📧 **Email** : support@novaquote.trading
